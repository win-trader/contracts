 ...
 */
export type FeeSource = {tag: "Opening", values: void} | {tag: "Borrow", values: void};
...
current_borrow_rate: i128;
  ...
  receiver_accrual_remainder: i128;
  /**
...
export type Key = {tag: "ConfigManager", values: void} | {tag: "OracleRouter", values: void} | {tag: "Vault", values: void} | {tag: "GlobalConfig", values: void} | {tag: "Initialized", values: void} | {tag: "Paused", values: void} | {tag: "NextPositionId", values: void} | {tag: "ActiveMarkets", values: void} | {tag: "Ledger", values: void} | {tag: "Version", values: void} | {tag: "Position", values: readonly [u64]} | {tag: "Market", values: readonly [string]} | {tag: "MarketDisabled", values: readonly [string]};
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "AAAAAgAAADlXaGljaCBjb2xsZWN0aW9uIHJvdXRlZCByZXZlbnVlIHRocm91Z2ggdGhlIHNwbGl0ICjCpzEzKS4AAAAAAAAAAAAACUZlZVNvdXJjZQAAAAAAAAIAAAAAAAAAAAAAAAdPcGVuaW5nAAAAAAAAAAAAAAAABkJvcnJvdwAA",
        ...
        "",
        ...
        "",
        "",
        ...
        "",
        ...
        "",
        "",
        ...
        "",
        "",

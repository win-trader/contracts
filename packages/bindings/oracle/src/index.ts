...
export const OracleError = {
   ...
   */
  5: {message:"NoPendingUpgrade"},
  /**
   * `upgrade` rejected — timelock has not elapsed yet.
   */
  6: {message:"UpgradeTimelockNotElapsed"},
  /**
   * `upgrade` rejected — `new_wasm_hash` does not match the proposed hash.
   */
  7: {message:"UpgradeHashMismatch"}
}

export type StorageKey = {tag: "Initialized", values: void} | {tag: "ConfigManager", values: void} | {tag: "Publisher", values: void} | {tag: "Price", values: readonly [string]} | {tag: "LastUpdate", values: readonly [string]} | {tag: "Version", values: void};
...
export interface Client {
  ...
  /**
   * Construct and simulate a set_publisher transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  set_publisher: ({caller, new_publisher}: {caller: string, new_publisher: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  static async deploy<T = Client>(
        ...
        {config_manager, publisher}: {config_manager: string, publisher: string},
    ...
    return ContractClient.deploy({config_manager, publisher}, options)
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        "",
        ...
        "",
        "AAAAAAAAAAAAAAANc2V0X3B1Ymxpc2hlcgAAAAAAAAIAAAAAAAAABmNhbGxlcgAAAAAAEwAAAAAAAAANbmV3X3B1Ymxpc2hlcgAAAAAAABMAAAAA",
  ...
  public readonly fromJSON = {
    migrate: this.txFromJSON<null>,
        ...
        set_publisher: this.txFromJSON<null>,
